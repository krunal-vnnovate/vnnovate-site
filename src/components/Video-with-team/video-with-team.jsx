        ...
        <div className="row justify-content-center mt-100">
          <div className="col-lg-7 col-md-10">
            <div className="s-head text-center mb-80">
              ...
              <h2>Weve Experience Team Member to Provide Solutions</h2>
            </div>
          </div>
        </div>
          ...
          <div className="col-lg-3 col-md-6">
            <div className="item text-center md-mb50">
              <div className="img">
                <Image
width="100"
height="100" src="/img/mobile-app/team/1.png" alt="" />
              </div>
              <div className="info">
          ...
          <div className="col-lg-3 col-md-6">
            <div className="item text-center md-mb50">
              <div className="img">
                <Image
width="100"
height="100" src="/img/mobile-app/team/2.png" alt="" />
              </div>
              <div className="info">
          ...
          <div className="col-lg-3 col-md-6">
            <div className="item text-center sm-mb50">
              <div className="img">
                <Image
width="100"
height="100" src="/img/mobile-app/team/3.png" alt="" />
              </div>
              <div className="info">
          ...
          <div className="col-lg-3 col-md-6">
            <div className="item text-center">
              <div className="img">
                <Image
width="100"
height="100" src="/img/mobile-app/team/4.png" alt="" />
              </div>
              <div className="info">
