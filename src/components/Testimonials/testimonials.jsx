                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="item">
                      <div className="icon mb-50">
                        <Image
width="100"
height="100" src="/img/mobile-app/qoute.png" alt="" />
                      </div>
                      <div className="text">
                        <p>
                      ...
                      <div className="info">
                        <div className="img">
                          <Image
width="100"
height="100" src="/img/mobile-app/clients/1.png" alt="" />
                        </div>
                        <div className="cont">
...
height="100" src="/img/mobile-app/qoute.png" alt="" />
                      ...
                      <div className="info">
                        <div className="img">
                          <Image
width="100"
height="100" src="/img/mobile-app/clients/2.png" alt="" />
                        </div>
                        <div className="cont">
...
height="100" src="/img/mobile-app/qoute.png" alt="" />
                      ...
                      <div className="info">
                        <div className="img">
                          <Image
width="100"
height="100" src="/img/mobile-app/clients/3.png" alt="" />
                        </div>
                        <div className="cont">
