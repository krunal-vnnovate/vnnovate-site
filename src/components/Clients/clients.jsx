        ...
        <div className="row">
          <div className="col-lg-4 valign md-mb50">
            <div className="sec-head mb-0">
              ...
              <h3 className="wow mb-20 color-font">Brands We Have Worked With</h3>
              <p>
                    ...
                    >
                      <div className="img">
                        {theme === "light" ? (
                          <Image
                            width="80"
                            height="70" src={item.lightImage} alt="" />
                        ) : (
                          <Image
                            width="100"
                            height="70" src={item.darkImage} alt="" />
                        )}
                        <Split>
                          <a
                            href="#0"
                    ...
                    >
                      <div className="img">
                        {theme === "light" ? (
                          <Image
                            width="80"
                            height="50" src={item.lightImage} alt="" />
                        ) : (
                          <Image
                            width="100"
                            height="70" src={item.darkImage} alt="" />
